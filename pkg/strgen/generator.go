...
const (
	...
	AlphabetOnlyLetters    = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz"
	AlphabetOnlyLettersLen = 52

	AlphabetOnlyNumbers    = "0123456789"
	AlphabetOnlyNumbersLen = 10
)
